...
const Footer = () => {
    return (
        <footer className="footer items-center p-4 bg-neutral text-neutral-content  text-center">
            <div className="items-center grid-flow-col text-center ">
                ...
                <p className='text-center'>Copyright © 2025 - All right reserved by WeβQuiz</p>
            </div>
