        ...
        <div className="card w-96 bg-gray-300 shadow-xl ">
            ...
            <div className="card-body items-center text-center">
                ...
                <div className="card-actions">
                    <button className="btn btn-secondary bg-gray-700 border-none hover:bg-black"><Link to={`/quizs/${subject.id}`}>Start Now<HiArrowRight className='ml-3'></HiArrowRight> </Link></button>
                </div>
            </div>
        </div>
    );
